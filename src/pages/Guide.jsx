...
const SECTIONS = [
  ...
  },
  {
    ...
    ico: '🗺',
    title: 'Maps & Models',
    body: 'The Holy Land in 3D is drawn from the text, not traced from an atlas: the tribal allotments of Yahawashawai (Joshua) 13–19, the millennial bands of Yachazaqaal (Ezekiel) 47–48 with the Holy Portion measured in cubits, the cities with their verses, and the rivers and seas under the names the Bible gives them. Tap any portion, city or water for its verses; every border and measurement says which verse it comes from. The Tzalam (Likeness) of the Dream is Daniel 2 in 3D: tap the dahab (gold), kasap (silver), nachash (brass), parazal (iron) and chasap (clay) for their verses, then play the aban (stone) gazar (cut) out laa (without) yadayan (hands) striking the tzalam (likeness) to pieces. The Bayath (House) of Yahawah is 1 Kings 6–7 in 3D, every measure in amah (cubits) from the text: watch the bayath (house) rise in the order the chapters give it, walk in from the gate of the gadawal (great) chatzar (court) to the arawan (ark) beneath the karawab (cherubim), or roam it on your own feet. The Bayath (House) Yachazaqaal (Ezekiel) Saw is Ezekiel 40–43 in 3D, measured in the long amah (cubit) of the man\'s qanah (reed): walk it gate by gate the way he was led — the chawamah (wall) five hundred square, the shairayam (gates), the chatzarawath (courts), the mazabach (altar), the hayakal (temple) and the most qadash (holy) place — or roam it on your own feet. The Mashakan (Tabernacle) and Its Machanah (Camp) is Exodus 25–27 and 40 in 3D with Numbers 2 about it: watch Mashah (Moses) raise it part by part in the text\'s own order — the qarashayam (boards), the yarayaihath (curtains) and the ahal (tent), the arawan (ark) behind the parakath (veil), the shalachan (table), the manawarah (lampstand), the altars and the basin, the chatzar (court) — then the inan (cloud), and the twelve camped about it by their dagal (standards); or roam it and the camp on your own feet.',
    links: [
      { to: '/models/holy-land', label: 'The Holy Land in 3D' },
      { to: '/models/holy-land?overlay=joshua', label: 'Joshua’s allotments' },
      { to: '/models/statue', label: 'The Tzalam (Likeness) of the Dream (Daniel 2)' },
      ...
      { to: '/models/revelation-city', label: 'The Shairay (City) Coming Down Out of Shamayam (Heaven) (Revelation 21–22)' },
