...
function reconstructableTails(tok) {
    ...
    if (isVerb && a.vt === 'impf' && a.nu === 'pl') endings.push(['𐤍', 'paragogic-nun']);
...
say('probe-heb-align v6 — v5 rules, without the combinatorial blowup (v5 could not finish)');
