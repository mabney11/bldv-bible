...
out.push('', 'CONFIRM: more than one Hebrew name carries this spelling — the WEB uses one English word for both; pick per context or leave the OT to the Hebrew-driven render');
for (const r of confirms) out.push(line(r));
